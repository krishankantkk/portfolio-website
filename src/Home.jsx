...
export default function Home() {
  return (
    <>
      <Particle />
      <div className="home flex flex-col items-center justify-center gap-4 h-screen align-center">
        ...
        <p className="socials text-white text-3xl flex gap-x-6 mt-2">
          ...
          <a
            href="https://drive.google.com/file/d/1qfxbUeKHLgUTWeJwHYKzmI7kN0nRymlH/view?usp=sharing"
            target="_blank"
          >
            <i className="fa-solid fa-file-lines text-white"></i>
          </a>
          <a
            href="https://www.linkedin.com/in/krishan-kant-2828aa217/"
            target="_blank"
          >
